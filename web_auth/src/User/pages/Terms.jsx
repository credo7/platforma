  ...
  return (
    <View style={styles.TermsContainer}>
      ...
      <p>
        ...
        которую сайт <strong>Power Games</strong>, (далее – Платформа)
        расположенный на доменном имени <strong>power-games.pro</strong> (а
        также его субдоменах), может получить о Пользователе во время
        использования сайта power-games.pro (а также его субдоменов), его
      ...
      <p>
        ...
        <strong>Power Games</strong>, которые организуют и (или) осуществляют
      ...
      <p>
        1.1.5. «Сайт <strong> Power Games</strong>» - это совокупность связанных
        между собой веб-страниц, размещенных в сети Интернет по уникальному
        адресу (URL): <strong>power-games.pro</strong>, а также его субдоменах.
      </p>

      <p>
        1.1.6. «Субдомены» - это страницы или совокупность страниц,
        расположенные на доменах третьего уровня, принадлежащие сайту Power
        Games, а также другие временные страницы, внизу который указана
        контактная информация Администрации
      </p>

      <p>
        1.1.5. «Пользователь сайта <strong>Power Games</strong> » (далее
        Пользователь) – лицо, имеющее доступ к сайту{" "}
        <strong>Power Games</strong>, посредством сети Интернет и использующее
        информацию, материалы и продукты сайта <strong>Power Games</strong>.
      </p>
      ...
      <p>
        ...
        через который Пользователь получает доступ на Платформа.
      </p>

      <p>
        1.1.8. «Возраст пользователя» (далее Возраст) — число лет прошедших с
        момента рождения.
      </p>

      <h2>2. Общие положения</h2>
      <p>
        2.1. Использование сайта Power Games Пользователем означает согласие с
      ...
      <p>
        ...
        Пользователь должен прекратить использование сайта Power Games .
      </p>

      <p>
        2.3. Настоящая Политика конфиденциальности применяется к сайту Power
        Games. Платформа не контролирует и не несет ответственность за сайты
        третьих лиц, на которые Пользователь может перейти по ссылкам, доступным
        на сайте Power Games.
      </p>
      ...
      <p>
        ...
        предоставляет по запросу Администрации при регистрации на сайте Power
        Games или при подписке на информационную e-mail рассылку.
      </p>
      ...
      <p>
        ...
        заполнения форм на сайте Power Games и включают в себя следующую
        информацию:
        <br />
        ...
        <br />
        3.2.6. данные банковских карт (при необходимости)
      </p>

      <p>
        3.3. Платформа защищает Данные, которые автоматически передаются при
        посещении страниц:
        <br />
        - IP адрес;
        <br />
      ...
      <p>
        ...
        сайта Power Games, требующим авторизации.
      </p>

      <p>
        3.3.2. Платформа осуществляет сбор статистики об IP-адресах своих
      ...
      <p>
        ...
        целях:
        <br />
        4.1.1. Идентификации Пользователя, зарегистрированного на сайте Power
        Games для его дальнейшей авторизации.
        <br />
        ...
        уведомлений, запросов, касающихся использования сайта Power Games,
        ...
        <br />
        4.1.6. Создания учетной записи для использования частей сайта Power
        Games, если Пользователь дал согласие на создание учетной записи.
        <br />
        4.1.7. Уведомления Пользователя по электронной почте.
        <br />
        4.1.8. Предоставления Пользователю эффективной технической поддержки при
        возникновении проблем, связанных с использованием сайта Power Games.
        <br />
        4.1.9. Предоставления Пользователю с его согласия специальных
        предложений, новостной рассылки и иных сведений от имени сайта Power
        Games.
      </p>
      ...
      <p>
        ...
        данных, необходимых для использования сайта Power Games, и давать
      ...
      <p>
        <strong>6.2. Пользователь обязан:</strong>
      </p>
      <p>6.2.1. Иметь Возраст старше 14 лет.</p>

      <p>
        <strong>6.3. Администрация обязана:</strong>
      </p>
      <p>
      ...
      <p>
        6.3.3. Принимать меры предосторожности для защиты конфиденциальности
      ...
      <p>
        6.3.4. Осуществить блокирование персональных данных, относящихся к
      ...
      <p>
        ...
        которой он может иметь доступ как к части сайта Power Games, несет лицо,
        предоставившее такую информацию.
      </p>

      <p>
        7.5. Пользователь соглашается, что информация, предоставленная ему как
        часть сайта Power Games, может являться объектом интеллектуальной
        ...
        информацию на сайте Power Games. <br />
      ...
      <p>
        ...
        свободном публичном доступе на сайте Power Games) допускается их
        распространение при условии, что будет дана ссылка на Платформа.
      </p>
      ...
      <p>
        ...
        коммуникационных данных, содержащихся на сайте Power Games или
      ...
      <p>
        ...
        размещенную пользователем на сайте Power Games, включая, но не
      ...
      <p>
        ...
        размещения на сайте Power Games, если иное не предусмотрено новой
        редакцией Политики конфиденциальности.
      </p>

      <p>
        9.3. Все предложения или вопросы касательно настоящей Политики
        конфиденциальности следует сообщать по адресу: admin@power-games.pro
      </p>
      ...
      <Link className="BtnToMain" to={`/user/register`}>
        Ознакомлен
      </Link>
    </View>
  );
